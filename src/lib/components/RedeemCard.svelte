...
{#if showConfirm}
	...
	>
		<div
			class="max-w-sm w-full rounded-xl border border-[#C9A45A]/40 bg-gradient-to-br from-[#1A2337] to-[#0B1020] p-6 shadow-2xl"
		...
		>
			<div class="text-center mb-4">
				...
				<h3 class="font-heading text-lg font-semibold text-[#F2E6D0]">Konfirmasi Redeem</h3>
