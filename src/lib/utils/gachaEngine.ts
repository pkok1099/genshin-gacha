...
export interface PullResult {
        ...
        iconUrl: string;
        bannerIconUrl?: string;  // Fallback from HoYoverse CDN for chars not in jmp.blue
}
...
let featured5Star: { id: string; name: string; element: string; bannerIconUrl?: string } | null = null;
let featured4Star: { id: string; name: string; element: string; bannerIconUrl?: string }[] = [];
let standard4Star: { id: string; name: string; element: string }[] = [];

/** Set banner data for the gacha engine */
export function setBannerPools(
        f5: { id: string; name: string; element: string; bannerIconUrl?: string } | null,
        f4: { id: string; name: string; element: string; bannerIconUrl?: string }[],
